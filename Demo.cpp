...
// int main() 
// {
// 	string text = "TOND vorri be haffy";
...
// 	cout << phonetic::find(text, "Pe") << endl;   // should print "be"
// 	cout << phonetic::find(text, "happy") << endl;   // should print "haffy"
// 	try {
// 		cout << phonetic::find(text, "hap") << endl;   // should throw an exception - "happ" is not a full word in the sentence
// 	} 
// 	catch (exception& ex) 
// 	{
